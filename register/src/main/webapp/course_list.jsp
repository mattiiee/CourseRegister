    ...
    <div class="row w-100">
        <form class="form-inline" action="course-list" method="post">
            <div class="form-group mx-4">
                ...
                <div class="pl-10 flex-box"><button style="border: 1px solid cadetblue"><a href="index.jsp">Back</a></button></div>
            </div>
        </form>
    </div>
                    ...
                    <div class="row bg-transparent">
                        ...
                        <div class="col-1">
                            <input type="checkbox" name="registeredSubjects"
                                   ${courseRegistered!=null && courseRegistered.exist(selectedSemester, subject.subjectId)?'checked' : ''}
